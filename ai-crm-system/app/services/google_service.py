...
def send_gmail_message(creds: Credentials, to: str, subject: str, message_text: str) -> dict:
    ...
    try:
        ...
        raise ValueError(f"An error occurred sending Gmail: {e}")


def create_calendar_event(creds: Credentials, title: str, description: str, start_time: datetime.datetime, end_time: datetime.datetime, attendees: list[str]) -> dict:
    ...
    try:
        ...
        raise ValueError(f"An error occurred creating Calendar event: {e}")
